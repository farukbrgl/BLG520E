...
f_ciphertext = open("p2_encrypted.txt", "r", newline='\n')
# f_ciphertext_one_line = open("ciphertext_one_line.txt", "w")
f_ciphertext_to_numbers = open("p2_encrypted_ciphernumbers.txt", "w")
...
f_ciphertext_one_line_read = open("p2_encrypted.txt", "r")
text_line = f_ciphertext_one_line_read.readlines()[0]

f_occurs_all = open("p2_occurs_all.txt", "w")
f_occurs_multi = open("p2_occurs_multi.txt", "w")
f_factors = open("p2_factors.txt", "w")
...
f_pattern_list = open("p2_pattern_list.txt", "w")
...
ct_k4 = []
ct_k5 = []
f_ciphertext_one_line = open("p2_encrypted.txt", "r")
